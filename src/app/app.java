...
public class app {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		System.out.println(
				"Insert path to the first CSV file (example: D:\\Eclipse Workspace\\CSV_Extractor\\src\\testCSV\\books1.csv):");
		...
		try {
			...
			List<String> common_columns = new ArrayList<String>(); // preparation for the common columns of the 2 CSV
																	// files
			...
			// organize the data by extracting the common and different data
